...
<head>
    ...
    <title>Benson's Food Recipe</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <a class="navbar-brand ml-5" href="http://localhost/devine/recipe.php">My Food Recipe</a>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Welcome to Benson's Food Recipe</strong></h1>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="caption"><strong>Bensoncode.com</strong></h1>
                ...
                <tbody>
                    ...
                    foreach ($result as $row) {
                        ...
                        <tr>
                            ...
                            <td id="recipeImage-<?= $recipeID ?>"><img src="http://localhost/devine/uploads/<?php echo $recipeImage ?>" class="img-fluid" style="height: 100px; width: 90px" alt="Recipe Image"></td>
